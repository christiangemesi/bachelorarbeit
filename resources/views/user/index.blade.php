...
@section('content')
    ...
    <div id="col-md-12 admin-panel">
        <div class="col-md-12 main-Panel">
            <div class="col-md-12">
                <h1>Themenkisten und Ausleihobjekte 2</h1>
            ...
            <div class="row">
                <div id="themebox-order-carousel" class="carousel slide col-md-12" data-interval="false"
                     data-ride="carousel">
                    <form id="orderform" name="orderform" action="{{url('user/createOrder')}}" method="post"
                          autocomplete="off">
                        <!-- Wrapper for slides -->
                                            ...
                                            @foreach ($categories as $category)
                                                @if ($category->name !== '-')
                                                    <option value="{{ $category->id }}"
                                                            data-category="{{ $category }}">{{ $category->name }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="list-group thekre-list">
                                        <ul id="themebox-list-ul">
                                            @foreach ($themeboxes as $themebox)
                                                <li>
                                                    <a href="#"
                                                       class="list-group-item list-group-item-action themebox-list"
                                                       id={{ $themebox->pk_themebox }}>{{ $themebox->title }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </div>
                                                ...
                                                <div class="form-group" id="themebox-infobox-select-date-container">
                                                    ...
                                                    <div id="themebox-time-select">
                                                        ...
                                                        <select id="dropdown-von" name="selectedVon">
                                                            <option value="dropdown-von-title" disabled selected>
                                                                Startzeit
                                                            </option>
                                                        ...
                                                        <select id="dropdown-bis" name="selectedBis">
                                                            <option value="dropdown-bis-title" disabled selected>
                                                                Endzeit
                                                            </option>
                                                            <option value="08:00">08:00</option>
                                                            <option value="08:30">08:30</option>
                                                    ...
                                                    <div class="row margin-right-legend">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div id="order-calendar-legend-block">
                                                                <div class="order-calendar-legend-text">Ausgeliehen
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div id="order-calendar-legend-new">
                                                                <div class="order-calendar-legend-text">Ihre Auswahl
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div id="order-calendar-legend-blocked-period">
                                                                <div class="order-calendar-legend-text">Bibliothek
                                                                    geschlossen
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="row thekre-row">
                                    <div class="col-md-12" id="personal-data-box">
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" class="form-control" name="surname" id="firstNameInput"
                                                   maxlength="40" placeholder="Max" onblur="firstNameValidate()"/>
                                            <span id="firstNameIcon"></span>
                                            <span id="firstNameInputStatus"
                                                  class="errorHeader">Vorname wird benötigt!</span>
                                        </div>

                                        <div class="form-group has-feedback">
                                            <label for="lastNameInput">Nachname * </label>
                                            <input type="text" class="form-control" name="name" id="lastNameInput"
                                                   maxlength="40" placeholder="Muster" onblur="lastNameValidate()"/>
                                            <span id="lastNameIcon" aria-hidden="true"></span>
                                            <span id="lastNameInputStatus"
                                                  class="errorHeader">Nachname wird benötigt!</span>
                                        </div>

                                        <div class="form-group has-feedback">
                                            <label for="emailInput">E-Mail Adresse *</label>
                                            <input type="email" class="form-control" name="email" id="emailInput"
                                                   maxlength="60" placeholder="max.muster@fhnw.ch"
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <input name="phone" type="text" class="form-control" id="phone"
                                                   maxlength="40" placeholder="0629231323" onblur="phoneValidate()"/>
                                            <span id="phoneIcon" aria-hidden="true"></span>
                                            <span id="phoneInputStatus"
                                                  class="errorHeader">Telefonnummer wird benötigt!</span>
                                        </div>
                                        <div class="form-group has-feedback">
                                        ...
                                        <div id="delivery-data-box">
                                            ...
                                            <div id="school-Address">
                                                <p id="user-delivery-info"><span
                                                    ...
                                                    an Aargauer Schulen ist kostenpflichtig.</p>
                                                <div class="form-group has-feedback">
                                                    <label class="form-control-label" for="schoolNameInput">Name der
                                                        Schule *</label>
                                                    <input type="text" class="form-control" name="schoolname"
                                                           id="schoolNameInput" maxlength="60"
                                                           placeholder="Musterschule" onblur="schoolnameValidate()"/>
                                                ...
                                                <div class="form-group has-feedback">
                                                    <label class="form-control-label" for="schoolstreetInput">Strasse
                                                        und Nr *</label>
                                                    <input type="text" class="form-control" name="schoolstreet"
                                                           id="schoolstreetInput" maxlength="60"
                                                           placeholder="Musterstrasse 2"
                                                           onblur="schoolstreetValidate()"/>
                                                ...
                                                <div class="form-group has-feedback">
                                                    <label class="form-control-label" for="schoolcityInput">PLZ und Ort
                                                        *</label>
                                                    <input type="text" class="form-control" name="schoolcity"
                                                           id="schoolcityInput" maxlength="60"
                                                           placeholder="2030 Musterstadt "
                                                           onblur="schoolcityValidate()"/>
                                                ...
                                                <div class="form-group has-feedback">
                                                    <label class="form-control-label" for="placeofhandoverInput">Abgabeort
                                                        an der Schule *</label>
                                                    <input type="text" class="form-control" name="placeofhandover"
                                                           id="placeofhandoverInput" maxlength="60"
                                                           placeholder="Sekretariat"
                                                           onblur="placeofhandoverValidate()"/>
                                                ...
                                                <div class="form-group has-feedback">
                                                    <label class="form-control-label" for="schoolphoneInput">Tel.-Nr.
                                                        der Schule *</label>
                                                    <input type="text" class="form-control" name="schoolphonenumber"
                                                           id="schoolphoneInput" maxlength="40" placeholder="0629231323"
                                                           onblur="schoolphoneValidate()"/>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <a class="align-left" href="#themebox-order-carousel" data-slide="prev">
                                            <button type="button" class="btn btn-default btn-lg thekre-button-left"
                                                    id="carousel-left">
                                                Zurück
                                            </button>
                                        </a>
                                    ...
                                    <div class="col-md-6">
                                        <a class="align-right" href="#themebox-order-carousel" data-slide="next">
                                            <button type="button" class="btn btn-success btn-lg thekre-button-right"
                                                    id="carousel-right">
                                                Weiter
                                            </button>
                                        </a>
                                        <a class="align-right">
                                            <button type="button"
                                                    class="button-confirm-order btn btn-success btn-lg thekre-button-right"
                                                    id="carousel-reserve-button">
                                                Bestellen
                                            </button>
                                        </a>
                                    </div>
                            ...
                            <div class="modal-dialog " role="document">
                                <div class="modal-content">
                                    ...
                                    <div id="modal-confirm-order-warning">
                                        <div class="panel-heading modal-header-warning"><span
                                                    class="glyphicon glyphicon-flash" id="thekmodal-glyphicon-flash"
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" id="button-submit-order"
                                                    class="btn btn-lg btn-warning float-right">Bestellen
                                            </button>
                                            <button type="button" class="btn btn-lg btn-default btn-modal float-left"
                        ...
                        <div class="modal-body">
                            <div class="panel-body">
                                <div class="form-group">
                                    <textarea id="themebox-content-modal-box" class="form-control" rows="20"
                                              disabled="true"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-lg btn-default btn-modal float-right"
        ...
        <div class="modal fade" id="modal-create-order-progress" data-backdrop="static" data-keyboard="false"
             tabindex="-1" role="dialog" aria-hidden="true" style="padding-top:15%;">
