...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('layouts.nav_poweruser', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script src="<?php echo e(asset('js/poweruser/order-form.js')); ?>"></script>
    <script src="<?php echo e(asset('js/poweruser/order-table.js')); ?>"></script>
                                    ...
                                    <div class="row thekre-row">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="orderAdd-thembox">
                                                <?php $__currentLoopData = $themeboxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thembox): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value=<?php echo e($thembox["pk_themebox"]); ?>><?php echo e($thembox["title"]); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\leihmich\thek-re-2\resources\views/poweruser/index.blade.php ENDPATH**/ ?>