    ...
    <div id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-text">
                <a href="{{ env('APP_URL') }}/poweruser"><div class="nav-text"> Bestellungen</div></a>
            </li>
            <li class="sidebar-nav-text">
                <a href="{{ env('APP_URL') }}/poweruser/themboxes"></span><div class="nav-text"> Themenkisten</div></a>
            </li>
            <li class="sidebar-nav-text">
                <a href="{{ env('APP_URL') }}/poweruser/logout"></span><div class="nav-text"> Abmelden</div></a>
            </li>
