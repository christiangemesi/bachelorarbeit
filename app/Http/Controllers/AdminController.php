...
class AdminController extends Controller
{
    ...
    public function sendEmail($order_id)
    {
        ...
        Mail::send('admin.mail_ready_pickup', $mail_data, function ($message) use ($mail_data) {
            $message->to($mail_data['receiver_mail'], $mail_data['receiver_name'] . " " . $mail_data['receiver_surname']);
            $message->bcc("bibliothek.windisch@fhnw.ch", "Bestellung ThekRe")->subject('Abholungseinladung Themenkiste');
        });
    }
