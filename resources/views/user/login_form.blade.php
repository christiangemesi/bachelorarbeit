                                ...
                                <div class="row thekre-row">
                                    ...
                                    <div id="user-edit-themebox-time-select">
                                        ...
                                        <select id="user-edit-dropdown-von" name="dropdown-von">
                                            <option value="user-edit-dropdown-von-title" disabled selected>
                                                Startzeit
                                            </option>
                                        ...
                                        <select id="user-edit-dropdown-bis" name="dropdown-bis">
                                            <option value="user-edit-dropdown-bis-title" disabled selected>Endzeit
                                            </option>
                                            <option value="08:00">08:00</option>
                                            <option value="08:30">08:30</option>
                                            <option value="09:00">09:00</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="datecreated-login"
                                               name="datecreated-login" disabled>
                                    </div>
                                    <hr>
                                    ...
                                    <div id="personal-data-box">
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" class="form-control lastname" id="lastNameInput"
                                                   name="lastname" maxlength="40" onkeyup="lastNameValidate()"
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" class="form-control surname" id="firstNameInput"
                                                   name="surname" maxlength="40" onkeyup="firstNameValidate()"
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" class="form-control email" id="emailInput"
                                                   name="email" maxlength="60" onkeyup="emailValidate()"
                                                   onblur="emailValidate()"/>
                                            <span id="emailIcon" aria-hidden="true"></span>
                                            <span id="emailInputStatus"
                                                  class="errorHeader">E-Mail wird benötigt!</span>
                                        </div>
                                        <div class="form-group has-feedback">
                                            <label class="float-left" for="phonenumber">Tel</label>
                                            <input type="text" class="form-control phonenumber" id="phone"
                                                   name="phonenumber" maxlength="40" onkeyup="phoneValidate()"
                                    ...
                                    <div id="order-delivery-type-deliver" class="display-none">
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" class="form-control" id="schoolNameInput"
                                                   name="schoolname" maxlength="60" onkeyup="schoolnameValidate()"
                                                   onblur="schoolnameValidate()" disabled/>
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" class="form-control" id="schoolstreetInput"
                                                   name="schoolstreet" maxlength="60"
                                                   onkeyup="schoolstreetValidate()" onblur="schoolstreetValidate()"
                                                   disabled/>
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <input type="text" class="form-control" id="schoolcityInput"
                                                   name="schoolcity" maxlength="60" onkeyup="schoolcityValidate()"
                                                   onblur="schoolcityValidate()" disabled/>
                                        ...
                                        <div class="form-group has-feedback">
                                            <label class="float-left" for="placeofhandover">Abgabeort an der
                                                Schule</label>
                                            <input type="text" class="form-control" id="placeofhandoverInput"
                                                   name="placeofhandover" maxlength="60"
                                                   onkeyup="placeofhandoverValidate()"
                                                   onblur="placeofhandoverValidate()" disabled/>
                                        ...
                                        <div class="form-group has-feedback">
                                            <label class="float-left" for="schoolphoneInput">Tel.-Nr. der
                                                Schule</label>
                                            <input type="text" class="form-control" id="schoolphoneInput"
                                                   name="schoolphonenumber" maxlength="40"
                                                   onkeyup="schoolphoneValidate()" onblur="schoolphoneValidate()"
                                                   disabled/>
