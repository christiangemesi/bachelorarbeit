...
<?php $__env->startSection('content'); ?>
    ...
    <script src="<?php echo e(asset('js/admin/blocked-periods.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('/js/admin/blocked-periods-form.js')); ?>"></script>
    <script src="<?php echo e(asset('js/admin/blocked-periods-table.js')); ?>"></script>
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-header modal-header-success">
                    <button type="button" class="close callback-close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
            ...
            <div class="modal-content">
                ...
                <div class="model-body">
                    <form id="edit-blocked-period-form" name="edit-blocked-period-form" autocomplete="off">
                        <input type="hidden" value="" name="blocked_period_id" id="blocked_period_id"/>
                        <div class="panel-body">
                            <div class="row thekre-row blocked-period-create-form-background" id="blocked-period-data-box">
                                <div class="form-group has-feedback">
                                    <label class="blocked-period-form-label" for="blocked-period-reason">Sperrfrist Grund *</label>
                                    <input type="text" class="form-control" id="edit-blocked-period-reason" name="reason" maxlength="100" placeholder="Betriebsferien"
                                           onblur="notEmptyValidation('edit-blocked-period-reason', 'reason-form-icon', 'reason-form-status')"/>
                                    <span id="reason-form-icon"></span>
                                    <span id="reason-form-status" class="errorHeader">Grund wird benötigt!</span>
                                </div>
                                <div class="form-group has-feedback">
    ...
    <div class="col-md-12 admin-panel data-table-thekre">
        ...
        <div class="panel panel-default no-border" id="table-content">
            <table id="new-blocked-period-table" class="data-table table table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                <?php $__currentLoopData = $blocked_periods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blocked_period): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>
                            <?php echo e($blocked_period["reason"]); ?>

                        </td>
                        <td>
                            <?php echo e($blocked_period["startdate"]); ?>

                        </td>
                        <td>
                            <?php echo e($blocked_period["enddate"]); ?>

                        </td>
                        <td>
                            <button type="button" class="button-update btn btn-primary button-edit-blocked-period" aria-label="edit"  value="<?php echo e($blocked_period["pk_blocked-period"]); ?>}" data-toggle="tooltip" data-placement="top" title="Sperrfrist bearbeiten">
                                <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                            </button>
                            <button type="button" class="button-delete-blocked-period btn btn-danger" value="<?php echo e($blocked_period["pk_blocked-period"]); ?>" aria-label="delete" data-toggle="tooltip" data-placement="top" title="Sperrfrist löschen">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\leihmich\thek-re-2\resources\views/admin/blocked-periods_index.blade.php ENDPATH**/ ?>