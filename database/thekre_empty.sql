...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 17. Nov 2023 um 13:10
...
--
-- Tabellenstruktur für Tabelle `tbl_blocked_period`
--
...
--
-- Tabellenstruktur für Tabelle `tbl_delivery`
--
...
--
-- Daten für Tabelle `tbl_delivery`
--

INSERT INTO `tbl_delivery` (`pk_delivery`, `type`)
VALUES (1, 'Abholung an Ort'),
...
INSERT INTO `tbl_login` (`pk_login`, `password`, `email`)
VALUES (1, '$2y$12$NWxo9pVcSoluaUE6UGqtfuuCtwW/HSy/yjXGRN0xt5i.8NQeWjnQ6', 'root'),
       (2, '$2y$10$53RC2xhBxY39.M1MuSYwCO68MdK.p6b/vYGYVlVppgbSs/EstWneu', NULL);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `tbl_mail`
--
...
--
-- Tabellenstruktur für Tabelle `tbl_password_resets`
--
...
INSERT INTO `tbl_status` (`pk_status`, `name`)
VALUES (1, 'Neu'),
       (2, 'Bereit'),
       (3, 'im Umlauf'),
       (4, 'zurück gekommen'),
...
--
-- Tabellenstruktur für Tabelle `tbl_themebox`
--
...
--
-- Indizes für die Tabelle `tbl_blocked_period`
--
ALTER TABLE `tbl_blocked_period`
    ADD PRIMARY KEY (`pk_blocked_period`);

--
-- Indizes für die Tabelle `tbl_delivery`
--
ALTER TABLE `tbl_delivery`
    ADD PRIMARY KEY (`pk_delivery`);

--
-- Indizes für die Tabelle `tbl_login`
--
ALTER TABLE `tbl_login`
    ADD PRIMARY KEY (`pk_login`);

--
-- Indizes für die Tabelle `tbl_mail`
--
ALTER TABLE `tbl_mail`
    ADD PRIMARY KEY (`pk_mail`);

--
-- Indizes für die Tabelle `tbl_order`
--
...
--
-- Indizes für die Tabelle `tbl_password_resets`
--
...
--
-- Indizes für die Tabelle `tbl_themebox`
--
...
--
-- AUTO_INCREMENT für Tabelle `tbl_themebox`
--
ALTER TABLE `tbl_themebox`
...
-- Add a nullable foreign key in tbl_themebox table
ALTER TABLE `tbl_themebox`
    ADD COLUMN `fk_category` int(11) DEFAULT NULL,
