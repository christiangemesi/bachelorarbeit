...
(1, '$2y$12$zT.HMzmoTHUsL7UjYXpQCef3Ddr04Z4djrexGBKT.Hao2Naz9oaV6', 'root@localhost'),
...
(92, 'Themenkiste', 'Signatur 2', 'Zyklus 2', 'Strichcode 2', '2', '2', '1 Box', 0, NULL, 2, 2),
(93, 'HoloLens', 'Signatur 1', 'Zyklus 1', 'Strichcode 1', '1 Gerät', '1', '1 HoloLens\r\n1 Ladekabel', 0, NULL, 6, 1);
...
--
ALTER TABLE `tbl_order`
  MODIFY `pk_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;
...
--
ALTER TABLE `tbl_password_resets`
  MODIFY `pk_password_resets` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
