...
class UserController extends Controller
{
    ...
    public function sendEmail($mail_data, $delivery_type)
    {
        ...
        Mail::send($view, $mail_data, function ($message) use ($mail_data) {
            $message->to($mail_data['receiver_mail'], $mail_data['receiver_name'] . " " . $mail_data['receiver_surname'])->bcc("nick.koch@fhnw.ch", "Koch Nick")->subject('Bestellbestätigung Themenkiste');
        });
    }
