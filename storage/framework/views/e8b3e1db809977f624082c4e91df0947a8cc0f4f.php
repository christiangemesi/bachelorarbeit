...
<?php $__env->startSection('content'); ?>
    ...
    <script src="<?php echo e(asset('js/user/themebox-data.js')); ?>"></script>
    ...
    <?php echo $__env->make('layouts.nav_user', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div class="col-md-12 main-Panel">
            ...
            <div class="row">
                <div id="themebox-order-carousel" class="carousel slide col-md-12" data-interval="false" data-ride="carousel">
                    <form id="orderform" name="orderform" action="<?php echo e(url('user/createOrder')); ?>" method="post" autocomplete="off">
                                        ...
                                        <div class="list-group thekre-list">
                                            <ul id="themebox-list-ul">
                                                <?php $__currentLoopData = $themeboxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $themebox): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
                                                    <a href="#" class="list-group-item list-group-item-action themebox-list" id=<?php echo e($themebox->pk_themebox); ?>><?php echo e($themebox->title); ?></a>
                                                    </li>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select name="delivery" id="thekre-dropdown" class="selectpicker form-dropdown">
                                            ...
                                            <?php $__currentLoopData = $deliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $delivery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option  value=<?php echo e($delivery->pk_delivery); ?>><?php echo e($delivery->type); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="modal fade" id="callback-modal" tabindex="-1">
                            <div class="modal-dialog " role="document">
                                <div class="modal-content">
                                    ...
                                    <?php echo $__env->make("layouts.callback_messages", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
